...
class GeminiService:
    ...
    async def generate_code(self, prompt_type: str, context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def generate_analysis(self, prompt_type: str, context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _prepare_analysis_prompt(self, prompt_type: str, context: Dict[str, Any]) -> str:
        """
    ...
    def _prepare_kubernetes_troubleshooting_prompt(self, context: Dict[str, Any]) -> str:
        """
