...
async def update_alert(alert_id: UUID, alert: Alert, current_user: dict = Depends(get_current_user)):
    """Update alert status"""
...
async def get_cost_optimization(current_user: dict = Depends(get_current_user)):
