...
from AgentProvision.core.models.agent_model import (Agent, AgentCreate,
                                              AgentResources, AgentResponse)
...
async def list_agents(
    tenant_id: UUID, current_user: dict = Depends(get_current_user_dependency)
):
...
async def create_agent(
    agent: AgentCreate, current_user: dict = Depends(get_current_user_dependency)
):
    """Create a new agent"""
...
async def get_agent(
    agent_id: UUID, current_user: dict = Depends(get_current_user_dependency)
):
    """Get agent details"""
