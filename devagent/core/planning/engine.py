...
class PlanningEngine:
    ...
    def create_solution_plan(self, ticket: Ticket, requirements: List[Requirement]) -> SolutionPlan:
        """
    ...
    def _create_task_from_requirement(self, requirement: Requirement, plan_id: str) -> Task:
        """
    ...
    def _estimate_effort(self, description: str) -> int:
        ...
        complexity = len(re.findall(r'\b(implement|create|add|build|develop)\b', description.lower()))
